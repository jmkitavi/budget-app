            ...
            <Animated.View style={[this.position.getLayout(), styles.wrap]}>
                <View style={styles.container}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        <Text style={{ fontSize: 16, color: '#555' }}>{'Incomes: Sh.' + this.props.incomes}</Text>
                        <Text style={{ fontSize: 16, color: '#e03e3e'}}>{ `Costs: Sh.${this.props.costs}/${this.props.percent}%`}</Text>
                    </View>     
                    
                    <Icon
                        size={30}
                        containerStyle={styles.iconRight}
                        name={this.state.moved ? 'chevron-right' : 'cog'}
                        type='font-awesome'
                        color='#fff'
